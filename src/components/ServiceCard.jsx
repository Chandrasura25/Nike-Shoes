const ServiceCard = ({ imgURL, label, subtext }) => {
  return (
    <div className="flex-1 sm:w-[350px] w-full rounded-[20px] sm:min-w-[350px] shadow-3xl px-10 py-16 transition-all">
      <div className="flex w-11 h-11 justify-center items-center bg-coral-red rounded-full">
        <img src={imgURL} alt={label} width={24} height={24} />
      </div>
      <h3 className="font-palanquin leading-normal font-bold text-3xl mt-5">
        {label}
      </h3>
